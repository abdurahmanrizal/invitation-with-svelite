        ...
        try {
            ...
            if (result.success && result.reservations) {
                const found = result.reservations.find(
                    (r: any) =>
                        r.reservationCode.toLowerCase() ===
                        reservationCode.toLowerCase(),
                );
                ...
                >
                    ...
                    <div class="p-3">
                        ...
                        <Card className="space-y-6 ">
                            {#if message.text}
                                <div
                                    class="mb-6 rounded-2xl p-4 {message.type ===
                                    'success'
                            ...
                            <div class="flex items-start justify-between gap-4">
                                <div>
                                    ...
                                    <p
                                        class="mt-2 text-gold-light font-semibold"
                                    >
                            ...
                            <div class="grid gap-4 sm:grid-cols-1">
                                ...
                                >
                                    <div
                                        class="flex items-center gap-3 text-gold-light"
                                    >
                                        <CalendarDays
                                            size={18}
                                            class="text-gold"
                                ...
                                >
                                    ...
                                    <span
                                        class="text-gold text-xl md:text-2xl font-semibold"
                                        >Buka di Maps</span
                                    >
                                </a>
                            </div>
